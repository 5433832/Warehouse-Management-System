...
<template>
  <div class="MainBody">
    ...
    >
      ...
      <el-table-column prop="用户名称" label="用户名称" width="90">
      </el-table-column>
      <el-table-column prop="密码" label="密码" width="140" align="center">
      </el-table-column>
      ...
      <el-table-column prop="电话" label="电话" width="140">
      </el-table-column>
      <el-table-column prop="级别" label="级别" width="90"
                       :filters="[{ text: 'Root', value: 'Root' },
                      { text: '管理员', value: '管理员' },
                       { text: '普通账户', value: '普通账户' }]"
      ...
      <el-table-column prop="执行操作" label="执行操作" width="180" align="center">
        <template slot-scope="scope">
    ...
    <el-dialog
      ...
      <el-form ref="form" :rules="rules" :model="form" label-width="80px">
        <el-form-item label="用户名称" prop="用户名称">
          <el-col :span="20">
            <el-input v-model="form.用户名称"></el-input>
          </el-col>
        </el-form-item>
